...
<form action="<?php echo $uri; ?>" method="post" name="adminForm">
	<div class="row-fluid">
		...
		<div class="center">
			<a href="<?php echo JUri::base().'index.php?option=com_osinvoice&view=invoice&task=edit';?>" class="btn btn-success jxif-width100"><i class="icon-plus-sign icon-white"></i>&nbsp;<?php echo Rb_Text::_('JTOOLBAR_NEW');?></a>
