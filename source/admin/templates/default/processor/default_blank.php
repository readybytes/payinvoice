...
<form action="<?php echo $uri; ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		...
		<div class="center">
			<a href="<?php echo JUri::base().'index.php?option=com_payinvoice&view=processor&task=selectProcessor';?>" class="btn btn-success jxif-width100"><i class="icon-plus-sign icon-white"></i>&nbsp;<?php echo JText::_('JTOOLBAR_NEW');?></a>
