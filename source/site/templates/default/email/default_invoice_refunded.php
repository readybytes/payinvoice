			...
			<tbody>
				<tr id="second-row">
					...
					<td id="second-middle" bgcolor="f8f8f8">
						...
						<p class="fontlist pp-lineWordSpacing" style="padding: 10px; margin-left: 15px;" mce_style="padding: 10px; margin-left: 15px;"><span style="font-size: 12pt; color: #4d4d4d;" mce_style="font-size: 12pt; color: #4d4d4d;" data-mce-mark="1">Thank you for choosing our product.Your purchase of <?php echo $rb_invoice['title']; ?> is completed. ><br><span style="font-size: 12pt; color: #4d4d4d;" mce_style="font-size: 12pt; color: #4d4d4d;" data-mce-mark="1"> <strong>Your details are as follows:</strong></span></p>
						<table class="fontlist pp-wordSpacing mceItemTable" align="center">
							<tbody>
								...
								<tr>
								<td class="col" align="right"><span style="font-size: 12pt; color: #4d4d4d;" mce_style="font-size: 12pt; color: #4d4d4d;" data-mce-mark="1">Paid Date:</span></td>
								<td class="col"><span style="font-size: 12pt; color: #4d4d4d;" mce_style="font-size: 12pt; color: #4d4d4d;" data-mce-mark="1"><?php echo $rb_invoice['paid_on']; ?></span></td>
								</tr>
							</tbody>
						</table>
					</td>
