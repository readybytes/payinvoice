			...
			<tbody>
				<tr id="second-row">
					...
					<td id="second-middle" bgcolor="f8f8f8">
						...
						<p class="fontlist pp-lineWordSpacing" style="padding: 10px; margin-left: 15px;"><span style="font-size: 12pt; color: #4d4d4d;"><?php echo Rb_Text::_('COM_PAYINVOICE_PAYMENT_ERROR_MESSAGE');?></span><br /><br /><span style="font-size: 12pt; color: #4d4d4d;"> <strong><?php echo Rb_Text::_('COM_PAYINVOICE_WEBSITE_DETAILS');?></strong></span></p>
