 ...
 */
class OsiHelperBuyer extends JObject
{
	...
	public function storeUser($data = array())
	{
		...
		if (!$user->bind($userData)) {
			JFactory::getApplication()->enqueueMessage(JText::sprintf('COM_OSI_BUYER_NOT_SAVED', $user->getError()));
			return false;
		}
		...
		if (!$user->save($updateonly)) {
			JFactory::getApplication()->enqueueMessage(JText::sprintf('COM_OSI_BUYER_REGISTRATION_FAILED', $user->getError()));
			return false;
		}
	}
