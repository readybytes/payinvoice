...
<div style="page-break-after:always; display:block;"> 
    ...
    <fieldset>
    	<legend>
			<span><h3><?php echo Rb_Text::_($status_list[$data['status']]);?></h3>
			</span>
		</legend>
				  ...
				  <p class="pp-pdf-margin-top-14"></p>
					    <table cellspacing ="0" class="pp-pdf-box pp-pdf-colored-border" border-collapse="collapse">
					    	<tr>
					    		...
					    		<td class="pp-pdf-colored-border">
					    			<p><b><?php echo Rb_Text::_('COM_PAYINVOICE_TOTAL'); ?></b></p>
		...
		<table style="border:0.5 solid #ccc; width:100%; cellspacing:0; cellpadding:0;" >
			<tbody>
				<tr>
					<th style="padding-top: 12px;padding-bottom: 10px;background-color: #eee;width: 48%;text-align:left;"><?php echo Rb_Text::_('COM_PAYINVOICE_ITEMS');?></th>
					<th style="padding-top: 12px;padding-bottom: 10px;background-color: #eee;text-align:right;"><?php echo Rb_Text::_('COM_PAYINVOICE_QUANTITY');?></th>
					<th style="padding-top: 12px;padding-bottom: 10px;background-color: #eee;text-align:right;"><?php echo Rb_Text::_('COM_PAYINVOICE_UNIT_PRICE');?></th>
					<th style="padding-top: 12px;padding-bottom: 10px;background-color: #eee;text-align:right;"><?php echo Rb_Text::_('COM_PAYINVOICE_AMOUNT');?></th>
				</tr>
			...
			<tr>
				<td>
			 		<table style="border-collapse:collapse;">
			 			...
			 			<tbody>							
							<tr>
								<td width="80%" class="pp-pdf-bottom-border"><p><?php echo Rb_Text::_('COM_PAYINVOICE_SUBTOTAL'); ?></p></td>
								<td width="20%" align="right" class="pp-pdf-bottom-border"><p><?php echo $currency_symbol." ".number_format($subtotal,2);?></p></td>
							</tr>
							
							<tr>
								<td width="80%" class="pp-pdf-bottom-border"><p><?php echo Rb_Text::_('COM_PAYINVOICE_DISCOUNT'); ?></p></td>
								<td width="20%" align="right" class="pp-pdf-bottom-border"><p><?php echo $currency_symbol." ".number_format($discount,2);?></p></td>
							</tr>
							
							<tr>
								<td width="80%" class="pp-pdf-bottom-border"><p><?php echo Rb_Text::_('COM_PAYINVOICE_TAX'); ?></p></td>
					 ...
					 <table style="border-collapse:collapse;">
					 	...
					 	<tr>
					 			<td width="80%">&nbsp;</td>
					 			<td width="10%"><p><b><?php echo Rb_Text::_('COM_PAYINVOICE_TOTAL'); ?></b></p></td>
		...
		<table style="border:0.2 solid #ccc; width:100%; cellspacing:0; cellpadding:0;">
			<thead>
	 			<tr>
	 				<th style="font-size: 80%; background-color: #eee;"><p><?php echo Rb_Text::_('COM_PAYINVOICE_INVOICE_TERMS_AND_CONDITIONS'); ?></p></th>
	 			</tr>
 			</thead> 			
 			<tbody>	
				<tr>
